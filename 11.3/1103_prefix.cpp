...
int main()
{
	...
	while(!feof(fptr)){
		...
		DataInfix.Split(a);
		DataInfix.ShowInfix();
		DataInfix.InfixToPre();
		DataInfix.ShowPrefix();
		data num = DataInfix.PreCalculate();
		printf("%d\n", num.value);
		a[0] = '\0';
	}
	return 0;
